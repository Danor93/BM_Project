...
public class CreateMenuScreenController {
    ...
    @FXML
    void CreateDessertInMenu(ActionEvent event) {

    }

    @FXML
    void CreateDrinksInMenu(ActionEvent event) {

    }

    @FXML
    void CreateMainDishesInMenu(ActionEvent event) {

    }

    @FXML
    void CreateSaladInMenu(ActionEvent event) {

    }

    @FXML
    void CreateStartInMenu(ActionEvent event) {
