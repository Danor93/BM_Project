...
public class getDishes {
	...
	public static ArrayList<Dish> getDishes(String restCode) {
		...
		String query = "";
		try {
				stmt = DBConnect.conn.prepareStatement("SELECT dishName,supplierName,choiceFactor,choiceDetails,ingredients,extra,price,dishType FROM bitemedb.dishes WHERE restId1=?");
