...
public enum MessageType {
	...
	get_Revenue_report, downloadPDF, showRelevantYearsAndQuarterly, W4C_Business_List, update_RefundTable,
	update_Budget_bussClient, changed_status_to_sended_succ, Company_Status_Not_Equale_To_Approved,
	Company_Status_Equale_To_Approved, set_Phone_number, ConfirmOpenNewBusinessAccount, supplier_not_match, rest_Name,
	InsertDelivery, ClientConfirm, orderDone, ShowHistogram, getYears, Account_Status_Active, Account_Status_Freeze,
	get_Rest_Name, check_account_status, check_account_status_Active, check_account_status_Freeze,
